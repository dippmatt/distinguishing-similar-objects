...
def plot_images(
    ...
    for i in range(bs):
        ...
        if images[i].shape[0] > 3:
            ...
            assert FIVE_CH 
            # Remove 4th and 5th channel
            single_image = images[i]
            print("Single Image Shape before: ", single_image.shape)
            #single_image = single_image[2:5]
            single_image = single_image[0:3]

            mosaic[y : y + h, x : x + w, :] = single_image.transpose(1, 2, 0)
        else:
